...
<br>
I set my target speed to 20 degrees persecond which seemed to work fairly well. If you look at the video above it takes about 20 seconds for my robot to complete one turn which means I am turning at about 20 degrees per second which was my target. I would be interested to see how low I could push the target degrees per second for my controller and have it still work. I would likely have to increase the integral coefficient term which would likely increase the oscialltion at the top and might make the turn less smooth. Nonetheless, I think that this graph, analysis, and video demonstrates my contoller works sufficiently well which was confirmed when I used it to actually start mapping.
<br>
